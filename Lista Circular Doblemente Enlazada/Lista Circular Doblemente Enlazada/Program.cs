...
namespace Lista_Circular_Doblemente_Enlazada
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            list.PrintAllNode();
            list.ModifyAtStart(12);
            list.ModifyAtEnd(6);
            list.ModifyAtPosition(4,2);
            list.PrintAllNode();
            Console.WriteLine("Inicio: " + list.GetAtStart());
            Console.WriteLine("Final: " + list.GetAtEnd());
            Console.WriteLine("Posición 4: " + list.GetAtPosition(4));
            list.DeleteAtStart();
            list.DeleteAtEnd();
